      ...
      <div class="card-body">
        <div class="row">
          <div class="col-12 col-md-12 col-lg-4 order-2 order-md-1">
            <div class="row">
              <div class="card-body box-profile">
                ...
                <h3 class="profile-username text-center">{{ $tentor->name }}</h3>
                <p class="text-muted text-center">{{ $tentor->email }}</p>
                <ul class="list-group list-group-unbordered mb-3">
                  <li class="list-group-item">
                    <b>Mapel</b> <a class="float-right">Jumlah mapel yg diampu</a>
                  </li>
                  <li class="list-group-item">
                    <b>Siswa</b> <a class="float-right">Jumlah siswa yg diampu</a>
                  </li>
                </ul>
          ...
          <div class="col-12 col-md-12 col-lg-8 order-1 order-md-2">
            <h3 class="text-primary">{{ $tentor->kode_tentor }}</h3>
            <div class="text-muted">
              <p class="text-sm">Username
                <b class="d-block">{{ $tentor->username }}</b>
              </p>
            </div>
            ...
            <ul class="list-unstyled">
              <li>
                <a href="#" class="btn-link text-secondary"><i
                    class="far fa-fw fa-file-word"></i>{{ $tentor->mapel }}
                </a>
              </li>
              <li>
